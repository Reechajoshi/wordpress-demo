...
function qtrans_header(){
	...
	foreach($q_config['enabled_languages'] as $language) {
		$css .=".qtrans_flag_".$language." { height:20px; width:10px; background:url(".$baseurl.'/'.$q_config['flag_location'].$q_config['flag'][$language].") no-repeat; background-size:cover; float:right; }\n";
	}
	$css .="</style>\n";
