...
class theme_widget_comments extends WP_Widget 
{
	...
	#Constructor
	#
	function theme_widget_comments()
	{
		$widget_ops = array(
			'classname' => 'widget-comments widget-post', 
			'description' => __('This widget will display a comments section.', 'TR')
		);
		$this->WP_Widget( THEME_SLUG. '_comments', THEME_NAME.' &raquo; Comments', $widget_ops );
	}
