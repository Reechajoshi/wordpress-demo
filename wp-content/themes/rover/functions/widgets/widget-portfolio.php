...
class theme_widget_portfolio extends WP_Widget 
{
	...
	{
		$widget_ops = array(
			'classname' => 'widget-portfolio widget-carousel', 
			'description' => __('This widget will display a portfolio section.', 'TR')
		);
		$this->WP_Widget( THEME_SLUG. '_portfolio', THEME_NAME.' &raquo; Portfolio', $widget_ops );
	}
