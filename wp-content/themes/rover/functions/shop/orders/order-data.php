...
<div class="order-data-table">
	...
	<div class="order-data-section clearfix">
		<div class="order-data-title"><?php echo __('Shopping Adderss:', 'TR'); ?></div><div class="order-data-box"><?php echo $order->formatted_shipping_address; ?></div>
	</div>
	<div class="order-data-section clearfix">
	...
	<div class="order-data-section clearfix">
		<div class="order-data-title"><?php echo __('Shopping Fee:', 'TR'); ?></div><div class="order-data-box"><?php echo price_currency_symbol($currency); ?><?php echo get_post_meta( $post->ID, '_payment_fee', true ); ?></div>
	</div>
