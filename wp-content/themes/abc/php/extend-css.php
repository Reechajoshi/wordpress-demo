...
if ( !function_exists( 'theme_extend_styles' ) )
{
	...
	{
		global $tr_config, $font_stacks, $google_fonts, $is_IE, $is_opera, $is_safari, $is_chrome;
...
.sortable-menu li a,
.single-post-pagenation li a { background: #'.$button_pagenation_bg_color.'; }'."\n";
...
.page-header-breadcrumbs .trail-end { color: #'.$page_header_text_color.'; }'."\n";
		...
		if($body_family != 'disabled'){ $output .= 'body, .product-list li .price span, .post-product-single .product-form .price span { font-family: '.$font_stacks[$body_family].'; }'."\n"; }
		if($site_name_family != 'disabled'){ $output .= '.site-name h1 { font-family: "'.$google_fonts[$site_name_family].'", serif, sans-serif; }'."\n"; }
		if($menu_family != 'disabled'){ $output .= 'nav { font-family: "'.$google_fonts[$menu_family].'", serif, sans-serif; }'."\n"; }
		if($hgroup_family != 'disabled'){ $output .= 'h1, h2, h3, h4, h5, h6 { font-family: "'.$google_fonts[$hgroup_family].'", serif, sans-serif; }'."\n"; }
		if($breadcrumbs_family != 'disabled'){ $output .= '.page-header-breadcrumbs { font-family: "'.$google_fonts[$breadcrumbs_family].'", serif, sans-serif; }'."\n"; }
		if($page_header_family != 'disabled'){ $output .= '.site-page-header h3 { font-family: "'.$google_fonts[$page_header_family].'", serif, sans-serif; }'."\n"; }
		if($meta_family != 'disabled'){ $output .= '.meta { font-family: "'.$google_fonts[$meta_family].'", serif, sans-serif; }'."\n"; }
		if($slogan_family != 'disabled'){ $output .= '.site-slogan p { font-family: "'.$google_fonts[$slogan_family].'", serif, sans-serif; }'."\n"; }
...
.related-product-lists li .price, 
.product-slide-list li .price, 
.widget-product li .price { font-family: "'.$google_fonts[$price_family].'", serif, sans-serif; }'."\n"; 
		}
...
.homepage-slideshow-warp .link a { font-family: "'.$google_fonts[$read_more_family].'", serif, sans-serif; }'."\n"; 
		}
		if($pagination_family != 'disabled')
		{ 
		$output .= '.pagination,
.normal-pagination,
.comment-pagination { font-family: "'.$google_fonts[$pagination_family].'", serif, sans-serif; }'."\n"; 
		}
		if($form_family != 'disabled'){ $output .= 'input, textarea { font-family: "'.$google_fonts[$form_family].'", serif, sans-serif; }'."\n"; }
		if($copyright_family != 'disabled'){ $output .= '.footer-message { font-family: "'.$google_fonts[$copyright_family].'", serif, sans-serif; }'."\n"; }
