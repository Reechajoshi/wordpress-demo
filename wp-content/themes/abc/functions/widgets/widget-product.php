...
class theme_widget_product extends WP_Widget 
{
	...
	#Constructor
	#
	function theme_widget_product()
	{
		$widget_ops = array(
			'classname' => 'widget-product widget-post', 
			'description' => __('This widget will display a product section.', 'TR')
		);
		$this->WP_Widget( THEME_SLUG. '_product', THEME_NAME.' &raquo; Product', $widget_ops );
	}
