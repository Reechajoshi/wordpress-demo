...
$tr_config['enable_update_notifier'] = get_theme_option($page, 'enable_update_notifier');
...
$tr_config['map_lat'] = get_theme_option($page, 'map_lat');
$tr_config['map_lng'] = get_theme_option($page, 'map_lng');
