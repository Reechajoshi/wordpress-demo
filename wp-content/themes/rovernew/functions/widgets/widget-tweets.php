...
class theme_widget_tweets extends WP_Widget 
{
	...
	function update($new_instance, $old_instance) 
	{
		...
		// Refresh Cache
		delete_transient(THEME_SLUG.'_tweet_cache_id_'.$this->id_base.'-'.$this->number);
	...
	<?php echo __theme_latest_tweet_posts($username, $tweet_count, $widget_id, $ignore_replies = true); ?>
