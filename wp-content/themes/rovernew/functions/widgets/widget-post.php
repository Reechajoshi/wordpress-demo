...
class theme_widget_post extends WP_Widget 
{
	...
	#Constructor
	#
	function theme_widget_post()
	{
		$widget_ops = array(
			'classname' => 'widget-blog widget-post', 
			'description' => __('This widget will display a post section.', 'TR')
		);
		$this->WP_Widget( THEME_SLUG. '_post', THEME_NAME.' &raquo; Posts', $widget_ops );
	}
