...
function theme_slideshow() 
{
	...
	<?php
		...
		$desc_text = __( get_meta_option('slideshow_desc_text'), 'TR' );
		$caption_text = __( get_meta_option('slideshow_caption_text'), 'TR' );
	...
	<a href="<?php echo $link_text_url; ?>"><div class="<?php echo $image_align; ?>"><img src="<?php echo $image_text; ?>" alt="<?php echo $caption_text; ?>" /></div>
	<div class="text">
